...
# --- DUMMY SERVER FOR RENDER (PORT ISSUE FIX) ---
app = Flask('')
@app.route('/')
def home():
    return "DCW BOT IS RUNNING"
...
user_data = {}
SYSTEM_INSTRUCTION = "You are DCW SUPPORT BOT. Only help with complaints. Reply in the same language user speaks."

@dp.message_handler(commands=['start'])
async def start(message: types.Message):
    await message.reply("<b>DCW Support Bot is Online!</b>\nHow can I help you today?")
...
async def handle_all(message: types.Message):
    ...
    try:
        ...
        reply = "Please provide your complaint details and click Submit."
